  ...
  return (
    ...
    >
      <div className="flex justify-between items-start">
        <h3 className="font-display text-4xl uppercase">{t.score}</h3>
      ...
      <div className="grid grid-cols-3 gap-4">
        <StatBox icon={<Zap size={20} />} label={t.damage} value={evaluation.damage} color="text-red-600" />
        <StatBox icon={<Smile size={20} />} label={t.humor} value={evaluation.humor} color="text-blue-600" />
        <StatBox icon={<Brain size={20} />} label={t.eq} value={evaluation.eq} color="text-emerald-600" />
      </div>
